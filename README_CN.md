...
> **免责声明**： 本软件按"原样"提供，不作任何明示或暗示的保证。使用者需自行承担风险。使用本软件即表示您同意作者不对因使用本软件而产生的任何损失、数据丢失或 API 额度消耗承担责任。
...
![Generate 标签页](screenshots/generate-tab.png)

### Model Info 标签页

![Model Info 标签页](screenshots/info-tab.png)
